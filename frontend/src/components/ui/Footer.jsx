      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="col-span-1">
            ...
            <ul className="flex flex-col gap-2">
              <li><a href="#" className="text-sm text-slate-500 hover:text-blue-500 dark:text-zinc-400 dark:hover:text-blue-400 transition-colors">Privacy Policy</a></li>
              <li><a href="#" className="text-sm text-slate-500 hover:text-blue-500 dark:text-zinc-400 dark:hover:text-blue-400 transition-colors">Terms of Service</a></li>
              <li><a href="#" className="text-sm text-slate-500 hover:text-blue-500 dark:text-zinc-400 dark:hover:text-blue-400 transition-colors">Cookie Policy</a></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="flex flex-col gap-2">
              <li className="text-sm text-slate-500 dark:text-zinc-400">hello@prestige.agency</li>
              <li className="text-sm text-slate-500 dark:text-zinc-400">+1 (555) 123-4567</li>
              <li className="text-sm text-slate-500 dark:text-zinc-400 mt-2">123 Innovation Drive<br/>Tech City, TC 90210</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-black/5 dark:border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-slate-500 dark:text-zinc-500">
            &copy; {currentYear} Prestige Agency. All rights reserved.
          </p>
